...
router.put('/API/admin/child/:child_user/paid', function (req, res, next) {
    console.log(req.body)
    Child.findOneAndUpdate({ _id:req.params.child_user }, { $push: { paidDates: req.body } }, function (err, child) {
